...
<head>
    ...
    <title>Parampara Events - User Management</title>
    <style>
    ...
    <div class="main-content">
        ...
        <div class="content-area">
            ...
            <div class="user-search-container">
                ...
                <a href="${pageContext.request.contextPath}/UserController?action=add" class="add-user-btn">
                    <span>➕</span>
                    <span>Add User</span> 
                </a>
            </div>
                        ...
                        <c:when test="${not empty userList && userList.size() > 0}">
                            <c:forEach var="user" items="${userList}">
                                <tr>
                                    ...
                                    <td>${user.number}</td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/UserController?action=edit&id=${user.id}" class="action-btn edit-btn">
                                            ✏️ Edit
                                        </a>
                                        <a href="${pageContext.request.contextPath}/UserController?action=delete&id=${user.id}" 
            ...
            <div class="debug-info">
                ...
                <p>userList attribute: ${not empty userList ? 'Present' : 'Not present'}</p>
                <p>userList size: ${not empty userList ? userList.size() : 'N/A'}</p>
                <p><a href="${pageContext.request.contextPath}/debug" target="_blank">View Database Debug Page</a></p>
            </div>
        </div>
    </div>
</body>
