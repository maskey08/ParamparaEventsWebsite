...
<head>
    ...
    <title>Parampara Events - Service Management</title>
    ...
    <div class="main-content">
        ...
        <div class="content-area">
            <div class="content-header">
                <h2 class="content-title">Service Management</h2>
            </div>
            
            <div class="service-search-container">
                <input type="text" class="service-search" placeholder="Search services..." />
                <a href="${pageContext.request.contextPath}/EventManagement?section=service&action=add" class="add-service-btn">
                    <span>➕</span>
            ...
            <table class="services-table">
                ...
                <tbody>
                    <c:choose>
                        <c:when test="${not empty serviceList && serviceList.size() > 0}">
                            <c:forEach var="service" items="${serviceList}">
                                <tr>
                                    ...
                                    <td>${service.type}</td>
                                    <td>${service.serviceTags}</td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/EventManagement?section=service&action=edit&id=${service.serviceId}" class="action-btn edit-btn">
                                            ✏️ Edit
                                        </a>
                                        <a href="${pageContext.request.contextPath}/EventManagement?section=service&action=delete&id=${service.serviceId}" 
                        ...
                        <c:otherwise>
                            <tr>
                                <td colspan="7" class="no-services">No services found</td>
                            </tr>
                        </c:otherwise>
                    </c:choose>
                </tbody>
